...
<head>
	...
	<style>
		*{box-sizing:border-box}
		...
		.theme-btn,#authBtn{width:32px;height:32px;border-radius:4px;cursor:pointer;display:flex;align-items:center;justify-content:center;background:#f0f0f0;border:1px solid #ddd;transition:all .5s}
		.theme-btn:hover,#authBtn:hover{background:#e0e0e0}
		.theme-btn svg,#authBtn svg{width:16px;height:16px;fill:#666}
		#password{width:32px;padding:8px;border:1px solid #ddd;border-radius:4px;transition:all .5s}
		#password.status-disconnected{background:rgba(255,107,129,.45)}
		#password.status-connecting{background:rgba(99,179,237,.45)}
		#password.status-connected{background:rgba(34,197,94,.45)}
		...
		body.dark #password.status-connecting{background:rgba(99,179,237,.5)}
		body.dark #password.status-connected{background:rgba(34,197,94,.5)}
		body.dark .theme-btn,body.dark #authBtn{background:#3d3d3d;border-color:#555}
		body.dark .theme-btn:hover,body.dark #authBtn:hover{background:#4d4d4d}
		body.dark .theme-btn svg,body.dark #authBtn svg{fill:#ccc}
